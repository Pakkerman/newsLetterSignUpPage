  ...
  return (
    <Layout>
      <div className=" flex h-full w-full max-w-md flex-col bg-slate-100 sm:h-[450px] sm:w-[450px] sm:max-w-5xl sm:flex-row-reverse sm:items-center sm:justify-center sm:rounded-3xl sm:p-6">
        <div className="pre flex h-full flex-col justify-between p-8 sm:px-6 sm:py-4">
          <div className=" flex h-[80%] flex-col justify-center space-y-8 sm:justify-evenly sm:space-y-4">
            <img
              className="pre h-16 w-16 sm:h-14 sm:w-14"
            ...
            <p>
              A confirmation email has been sent to eamil@example.com. Please
              open it and click the button inside to confirm your suscription
            </p>
          </div>
          <Link href="/#">
